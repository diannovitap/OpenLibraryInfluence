  ...
  @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Roboto:wght@400;500;700&display=swap');
    ...
    <div class="p-16">
        ...
        <div class="bg-[#F4F4F4] px-10 pt-10 pb-20 mt-10 rounded-md">
            <h1 class="text-2xl font-bold text-center">Fasilitas Cek Similarity, iThenticate dan Turnitin</h1>
            <div class="flex gap-10 mt-10">
                <div class="bg-white rounded-lg w-9/12 px-12 py-5">
                    <h1 class="text-xl font-bold">Fasilitas Cek Similarity, iThenticate dan Turnitin</h1>
                    <div class="mt-5 flex justify-center pb-5">
                        <img src="/assets/similarity.png" alt="Photo of Fasilitas Cek Similarity, iThenticate dan Turnitin">
                    </div>
                </div>
                <div class="w-3/12">
                    <div>
                        ...
                        <div class="bg-white py-3 font-medium rounded-b-lg">
                            <div class="flex">
                                ...
                                <p class="text-left w-1/2">28 November 2022</p>
                            </div>
                            <div class="flex">
