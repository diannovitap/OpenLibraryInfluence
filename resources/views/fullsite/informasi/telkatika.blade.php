  ...
  @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Roboto:wght@400;500;700&display=swap');
    ...
    <div class="p-16">
        ...
        <div class="bg-[#F4F4F4] px-10 pt-10 pb-20 mt-10 rounded-md">
            <h1 class="text-2xl font-bold text-center">User Guide Author dan Reviewer Jurnal TELKATIKA</h1>
            <div class="flex gap-10 mt-10">
                <div class="bg-white rounded-lg w-9/12 p-5">
                    <h1 class="text-xl font-bold">User Guide Author dan Reviewer Jurnal TELKATIKA</h1>
                    <ul class="text-[#07559F] font-medium leading-tight mt-5">
                        <li>User Guide Submit Jurnal TELKATIKA untuk Author</li>
                        <li>User Guide Jurnal TELKATIKA untuk Reviewer</li>
                    </ul>
                </div>
                <div class="w-3/12">
                    <div>
                        ...
                        <div class="bg-white py-3 font-medium rounded-b-lg">
                            <div class="flex">
                                ...
                                <p class="text-center w-1/2">13 April 2023</p>
                            </div>
                            <div class="flex">
