        ...
        <main>
            <div class="p-16">
                ...
                <div class="bg-[#F4F4F4] px-10 pt-10 pb-20 mt-10 rounded-md">
                    <h1 class="text-2xl font-bold text-center">Cara Akses Koleksi Electronic Book Open Library</h1>
                    <div class="flex gap-10 mt-10">
                        <div class="bg-white rounded-lg w-9/12 px-12 py-5">
                            <h1 class="text-xl font-bold">Cara Akses Koleksi Electronic Book Open Library</h1>
                            <div class="flex justify-between mt-5">
                                <img src="/assets/electronic1.png" alt="Photo of Electronic Book Open Library">
                                <img src="/assets/electronic2.png" alt="Photo of Electronic Book Open Library">
                                <img src="/assets/electronic3.png" alt="Photo of Electronic Book Open Library">
                            </div>
                            <div class="flex justify-between mt-5">
                                <img src="/assets/electronic4.png" alt="Photo of Electronic Book Open Library">
                                <img src="/assets/electronic5.png" alt="Photo of Electronic Book Open Library">
                                <img src="/assets/electronic6.png" alt="Photo of Electronic Book Open Library">
                            </div>
                        </div>
                        <div class="w-3/12">
                            <div>
                                ...
                                <div class="bg-white py-3 font-medium rounded-b-lg">
                                    <div class="flex">
                                        ...
                                        <p class="text-center w-1/2">18 May 2023</p>
                                    </div>
                                    <div class="flex">
